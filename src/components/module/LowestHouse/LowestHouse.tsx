...
export default function LowestHouse({id,price,img,title,city,bathroom,room,meterage,status}:CheapestHousesItem) {
  return (
    <>
      <div className=" bg-white rounded-lg shadow-sm ">
        ...
        <div className="p-5  ">
          <div className="border-b-1  border-b-gray-200">
            <Link to={`/property/${id}`} className="hover:underline  decoration-black">
        ...
        <div className="px-5 pb-5">
          <Link to={`/property/${id}`} className="hover:underline text-gray-main text-[13px]">
              {status}
          </Link>
