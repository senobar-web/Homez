      ...
      <section className="mb-10">
        <div className="breadcrumb_about">
          <div className="container">
            <h1 className=" mb-3 mt-0 mt-lg-5 text-gray-main font-bold text-2xl">درباره ما</h1>
            <Breadcrumb />
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 text-black">
            ...
            <div className="text-gray-light">
              <p className="mb-3 lg:mb-8 ">
                ...
                متون بلکه روزنامه و مجله در ستون و سطرآنچنان که و مجله در ستون و سطرآنچنان که لازم است
              </p>
              <p>
                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و
                متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم
                از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان
                که لازم است
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 text-black space-y-10 mt-20">
                <div className="pl-3">
                  ...
                  <h3 className="text-gray-main font-bold text-xl mb-5">ویلای مدرن</h3>
                  <p className="text-gray-main text-sm">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم</p>
                </div>
                <div className="px-3">
                  <div className="mb-5 size-16 bg-gray-100 group hover:bg-black flex items-center justify-center rounded-full transition duration-300 ease-in-out ">
                    <MdPayments className="size-7  group-hover:text-white transition  duration-300 ease-in-out " />
