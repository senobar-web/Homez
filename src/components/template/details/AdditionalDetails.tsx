        ...
        <div className="w-full">
          <div className="shadow-xs  px-5 py-7 rounded-2xl text-[#182A20] bg-white">
            ...
            <p>
              ...
              کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد، کتابهای زیادی در شصت و سه درصد گذشته حال است
            </p>
        ...
        <div className="w-full md:w-[650px]  ">
          <div className="shadow-xs px-5 py-4 rounded-2xl bg-white">
            <div className="flex items-center gap-4 mb-4">
              <img className="w-20 h-20 rounded-full" src="/img/m14-.webp" alt="" loading="lazy" />
              <div className="font-medium text-[#182A20] ">
                <div className="text-2xl">مینا خشای </div>
                <div className="text-sm ">(+98)021-555-888</div>
              </div>
            </div>
            <button className="bg-red py-4 px-5 w-full rounded-xl text-white font-bold">مشاهده پروفایل</button>
          </div>
          <Form />
