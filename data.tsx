...
const ApartmentItems = [
  {
    ...
    title: "ویلا",
    icon: (
      <GiGreenhouse className="text-black size-9 group-hover:text-gray-200" />
    ),
    count: 4,
  },
  {
    ...
    title: "خانه",
    icon: (
      <RiHome6Line className="text-black size-9 group-hover:text-gray-200" />
    ),
    count: 7,
  },
  {
    ...
    title: "آپارتمان ها",
    icon: (
      <PiBuildingApartmentLight className="text-black size-9 group-hover:text-gray-200" />
    ),
    count: 3,
  },
  {
    ...
    title: "دفتر",
    icon: (
      <RiHomeOfficeLine className="text-black size-9 group-hover:text-gray-200" />
    ),
    count: 4,
  },
  {
    ...
    title: "خانه کلنگی",
    icon: (
      <SiHomeadvisor className="text-black size-9 group-hover:text-gray-200" />
    ),
    count: 2,
  },
  {
    ...
    title: "خانه ییلاقی",
    icon: (
      <GiWindowBars className="text-black size-9 group-hover:text-gray-200" />
    ),
    count: 1,
  },
];
